...
hiscr <- function(baseline_abscess, baseline_nodule, baseline_fistula,
  ...
  checkmate::assert_integerish(baseline_nodule, lower = 0, len = length(baseline_abscess), null.ok = FALSE)
  checkmate::assert_integerish(baseline_fistula, lower = 0, len = length(baseline_abscess), null.ok = FALSE)
  checkmate::assert_integerish(timepoint_abscess, lower = 0, len = length(baseline_abscess), null.ok = FALSE)
  checkmate::assert_integerish(timepoint_nodule, lower = 0, len = length(baseline_abscess), null.ok = FALSE)
  checkmate::assert_integerish(timepoint_fistula, lower = 0, len = length(baseline_abscess), null.ok = FALSE)
